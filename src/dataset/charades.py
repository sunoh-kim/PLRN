...
class CharadesDataset(AbstractDataset):
    def __init__(self, config):
        ...
        if self.feature_type == "I3D":
            self.feat_path = config.get(
                "video_feature_path",
                "/home/pil-kso/PycharmProjects/Dataset/charades/features/i3d_finetuned/{}.npy"
            )
        else:
        ...
        ann_path = "/home/pil-kso/PycharmProjects/Dataset/charades/annotations/charades_sta_{}.txt".format(self.split)
        aux_ann_path = "/home/pil-kso/PycharmProjects/Dataset/charades/annotations/Charades_v1_{}.csv".format(self.split)
    ...
    def generate_labels(self, config):
        ...
        if not os.path.exists(self.paths["query_labels"]):
            ...
            train_ann_path = "/home/pil-kso/PycharmProjects/Dataset/charades/annotations/charades_sta_train.txt"
            train_aux_path = "/home/pil-kso/PycharmProjects/Dataset/charades/annotations/Charades_v1_train.csv"
...
def get_loader():
    conf = {
        "train_loader": {
            ...
            "split": "train",
            "batch_size": 1,
            "data_dir": "/home/pil-kso/PycharmProjects/Dataset/charades",
            "video_feature_path": "/home/pil-kso/PycharmProjects/Dataset/charades/features/i3d_finetuned/{}.npy",
            "max_length": 10,
